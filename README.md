...
[![crates.io](https://img.shields.io/badge/crates.io-0.3.1alpha3-orange.svg)](https://crates.io/orbtk/0.3.1-alpha3)
...
Each widget has to implement the [Template trait](https://github.com/redox-os/orbtk/blob/develop/api/src/widget_base/template.rs). The template defines the default values of a widget's properties as well as its structure. A
...
The state of a widget is used to update its inner state. Each state has to implement the [State trait](https://github.com/redox-os/orbtk/blob/develop/api/src/widget_base/state.rs). The inner state of a widget is represented by the 
...
The [Context parameter](https://github.com/redox-os/orbtk/blob/develop/api/src/widget_base/context.rs) of the update method provides access to the state's widget (entity) and its properties (components). It also provides functions to access the children of the widget, and to manipulate the widget tree.
...
implement the [Localization](https://github.com/redox-os/orbtk/blob/develop/localization/src/localization.rs) trait.
...
It is possible to register a localization service on an application. There is also a ready to use [RonLocalization](https://github.com/redox-os/orbtk/blob/develop/localization/src/ron_localization/mod.rs) service, that can read localization dictionaries in the [RON](https://github.com/ron-rs/ron) format.
...
To switch the language on runtime the `set_language` method of the [Context](https://github.com/redox-os/orbtk/blob/develop/api/src/widget_base/context) struct can be used.
...
* [api](https://github.com/redox-os/orbtk/tree/develop/api): base api elements of OrbTk e.g. widget and application parts
* [proc_macros](https://github.com/redox-os/orbtk/tree/develop/proc_macros): procedural helper macros
* [render](https://github.com/redox-os/orbtk/tree/develop/render): cross platform 2D/3D render library
* [shell](https://github.com/redox-os/orbtk/tree/develop/shell): cross platform window and event handling
* [theming](https://github.com/redox-os/orbtk/tree/develop/theming): provide mechanism to style OrbTk UI's in rust and ron (replaces css-engine)
* [tree](https://github.com/redox-os/orbtk/tree/develop/tree): tree structure based on DCES
* [utils](https://github.com/redox-os/orbtk/tree/develop/utils): helper structs and traits
* [widgets](https://github.com/redox-os/orbtk/tree/develop/widgets): base widget library
