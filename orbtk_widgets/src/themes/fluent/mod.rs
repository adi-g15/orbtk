...
pub fn register_fluent_fonts(theme: Theme) -> Theme {
    theme
        .register_font("Selawik-Regular", fonts::SELAWIK_REGULAR_FONT)
        .register_font("Selawik-Bold", fonts::SELAWIK_BOLD_FONT)
        .register_font("Selawik-Light", fonts::SELAWIK_LIGHT_FONT)
        .register_font("MDL2-Assets-Regular", fonts::MDL2_ICONS_FONT)
        // register also material icon fonts because OrbTk's default widget library relies on its availability.
        .register_font(
            "MaterialIcons-Regular",
            super::default::fonts::MATERIAL_ICONS_FONT,
        )
}
